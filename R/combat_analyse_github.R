...
file <- file("/Users/charlie/Desktop/my_projects/neurotransmitter/github/results/combat_vs_raw.txt", "w")
...
write.table(results_df, file = "/Users/charlie/Desktop/my_projects/neurotransmitter/github/results/combat_vs_raw.csv", sep = ",", row.names = FALSE, quote = FALSE)
...
pdf_file <- "/Users/charlie/Desktop/my_projects/neurotransmitter/github/results/boxplot_combat_vs_raw.pdf"
