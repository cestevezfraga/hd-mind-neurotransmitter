...
writetable(data,'/Users/petermccolgan/Desktop/mind/yas_node_results.csv')
...
writetable(T3,'/Users/petermccolgan/Desktop/mind/yas_node_strength.csv')
...
title('Early preHD: HDGEC vs. Controls')
ylim([min(T6.Strength) max(T6.Strength)])
% using exportgraphics()
exportgraphics(gca,'/Users/petermccolgan/Desktop/mind/YAS_highres.png','Resolution','600')
