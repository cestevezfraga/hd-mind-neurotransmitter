...
fileID = fopen('YAS_cp_results.csv','w');
...
YAS_matrix_cp = matrix;
save('YAS_matrix_cp','YAS_matrix_cp')
...
YAS_edge_cp = matrix(node_column,node_column);
save ('YAS_edge_cp.txt', 'YAS_edge_cp', '-ascii')
...
writetable(data,'YAS_node_cp.txt','Delimiter',' ','WriteVariableNames',0)
