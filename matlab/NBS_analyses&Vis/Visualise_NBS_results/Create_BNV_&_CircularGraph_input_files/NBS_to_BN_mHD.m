...
fileID = fopen('mHD_cp_results.csv','w');
...
mHD_matrix_cp = matrix;
save('mHD_matrix_cp','mHD_matrix_cp')
...
mHD_edge_cp = matrix(node_column,node_column);
save ('mHD_edge_cp.txt', 'mHD_edge_cp', '-ascii')
...
writetable(data,'mHD_node_cp.txt','Delimiter',' ','WriteVariableNames',0)
