...
%% Graph theory ananlyses&Vis

%% permutation testing script
% This contains the script for permutation testing and needs to be added to
% the path when running the scripts in 'Groupwise_analyis_Violinplot_visualisation' folder

%% Groupwise_analyis_Violinplot_visualisation
% This folder contains the scripts for groupwise graph theory analyses
% including permutation testing and generation of violin plots for
% significant results
